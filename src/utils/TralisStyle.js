import s1Circle from '../images/lines/s1kreis.url.svg';
import s2Circle from '../images/lines/s2kreis.url.svg';
import s3Circle from '../images/lines/s3kreis.url.svg';
import s4Circle from '../images/lines/s4kreis.url.svg';
import s6Circle from '../images/lines/s6kreis.url.svg';
import s7Circle from '../images/lines/s7kreis.url.svg';
import s8Circle from '../images/lines/s8kreis.url.svg';
import s20Circle from '../images/lines/s20kreis.url.svg';

import s1Arrow from '../images/lines/s1pfeil.url.svg';
import s2Arrow from '../images/lines/s2pfeil.url.svg';
import s3Arrow from '../images/lines/s3pfeil.url.svg';
import s4Arrow from '../images/lines/s4pfeil.url.svg';
import s6Arrow from '../images/lines/s6pfeil.url.svg';
import s7Arrow from '../images/lines/s7pfeil.url.svg';
import s8Arrow from '../images/lines/s8pfeil.url.svg';
import s20Arrow from '../images/lines/s20pfeil.url.svg';
